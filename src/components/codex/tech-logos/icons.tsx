...
export function PrismaLogo({ className, ...props }: LogoProps) {
  return (
    <svg viewBox="0 0 24 24" fill="none" className={className} aria-hidden="true" {...props}>
      ...
      <path d="M12 9L8 17h8L12 9Z" stroke="currentColor" strokeWidth="1" strokeLinejoin="round" />
    </svg>
  )
}
...
export function ZustandLogo({ className, ...props }: LogoProps) {
  return (
    <svg viewBox="0 0 24 24" fill="none" className={className} aria-hidden="true" {...props}>
      ...
      {/* Head */}
      <path d="M5 10a7 7 0 0 1 14 0v4a7 7 0 0 1-14 0v-4Z" fill="currentColor" opacity="0.12" />
      <path d="M5 10a7 7 0 0 1 14 0v4a7 7 0 0 1-14 0v-4Z" stroke="currentColor" strokeWidth="1.5" />
      {/* Eyes */}
